...
//         success: false,
//         message: '❌ No documents to upload. Add PDFs to data/medical-documents/ first.',
//       }, { status: 400 });
//     }
...
//       metadata: {
//         ...doc.metadata,
//         case_id: doc.metadata.specialty || 'general',
...
//     // Step 3: Prepare documents for Pinecone with DYNAMIC case_id
//     const pineconeDocuments = documents.map((doc, index) => {
//       const filename = doc.metadata.source?.toLowerCase() || '';
//       const content = doc.pageContent.toLowerCase();
      
//       // Determine case_id dynamically based on content keywords
//       let caseId = 'GENERAL';
...
//       } 
//       // Dementia keywords
//       else if (content.includes('dementia') || content.includes('memory') || 
//                content.includes('alzheimer') || content.includes('cognitive decline') ||
//                content.includes('carer burden') || content.includes('mrs. doe') ||
//                content.includes('vascular dementia')) {
//         caseId = 'PSYCH_DEMENTIA_001';
//       }
//       // SSRI/Sexual dysfunction keywords
...
//       else if (content.includes('weight gain') || content.includes('olanzapine') || 
//                content.includes('metabolic') || content.includes('obesity')) {
...
//       pineconeDocuments.reduce((acc: any, doc) => {
